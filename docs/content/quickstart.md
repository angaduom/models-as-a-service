...
```bash
export MAAS_REF="v0.0.2"  # Use the latest release tag, or "main" for development
...
!!! note "Using Release Tags"
    ...
    The release workflow automatically updates all `MAAS_REF="v0.0.2"` references in documentation and scripts
